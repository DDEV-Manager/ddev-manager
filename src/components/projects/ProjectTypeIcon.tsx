...
export function ProjectTypeIcon({
  ...
  return <Icon className={cn(sizeClass, className)} aria-hidden={ariaHidden} />;
}
...
> = {
  ...
  backdrop: ({ className, "aria-hidden": ariaHidden }) => (
  ...
  craftcms: ({ className, "aria-hidden": ariaHidden }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden={ariaHidden}>
  ...
  drupal: ({ className, "aria-hidden": ariaHidden }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden={ariaHidden}>
  ...
  laravel: ({ className, "aria-hidden": ariaHidden }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden={ariaHidden}>
  ...
  magento: ({ className, "aria-hidden": ariaHidden }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden={ariaHidden}>
  ...
  magento2: ({ className, "aria-hidden": ariaHidden }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden={ariaHidden}>
      <path d="M12 24l-4.455-2.572v-12L12 6.857l4.455 2.571v12L12 24zm0-14.572L9.273 11.14v8.572L12 21.429l2.727-1.715V11.14L12 9.428zM22.909 6v12l-2.727 1.571v-12L12 2.57 3.818 7.571v12L1.091 18V6L12 0l10.909 6z" />
    </svg>
  ),
  ...
  php: ({ className, "aria-hidden": ariaHidden }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden={ariaHidden}>
  ...
  shopware6: ({ className, "aria-hidden": ariaHidden }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden={ariaHidden}>
  ...
  silverstripe: ({ className, "aria-hidden": ariaHidden }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden={ariaHidden}>
  ...
  typo3: ({ className, "aria-hidden": ariaHidden }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden={ariaHidden}>
  ...
  wordpress: ({ className, "aria-hidden": ariaHidden }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden={ariaHidden}>
